...
\author{%
  \begin{tabular}{rl}
    ...
    Lenny Briclet    & student no.\ \textit{\ldots} \\[0.2em]
    André Fonseca    & student no.\ \textit{\ldots} \\[0.2em]
    Rafael Gufler    & student no.\ \textit{\ldots}
  \end{tabular}\\[0.45em]
