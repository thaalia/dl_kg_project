...
\textbf{Time budget} & TransE: MPS (Apple M-series); RotatE: CPU (MPS lacks complex-norm support). \\
\end{tabular}
\normalsize
...
\centering
\small
\caption{Preliminary filtered metrics on the test set (15 epochs, $d=128$, Adam, lr=$10^{-3}$, seed=42).}
\begin{tabular}{@{}lccccc@{}}
\toprule
Model & MRR & H@1 & H@3 & H@10 & Notes \\
\midrule
TransE & 0.129 & 0.057 & 0.152 & 0.263 & 15 ep., bs=1024, MPS (439s) \\
RotatE & \textbf{0.234} & \textbf{0.159} & \textbf{0.263} & \textbf{0.378} & 15 ep., bs=1024, GPU (169s) \\
\bottomrule
\end{tabular}
\end{table}
